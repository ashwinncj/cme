            ...
            <tbody>
                ...
                foreach ($info as $value) {
                    ...
                    <tr>
                        ...
                        <td><?php echo isset($value['contact_person']) ? $value['contact_person'] : ''; ?></td>
                        <td><?php echo isset($value['email']) ? $value['email'] : ''; ?></td>
                        <td><?php echo isset($value['phone_number']) ? $value['phone_number'] : ''; ?></td>
                        <td><?php echo isset($value['category']) ? $value['category'] : ''; ?></td>
                        <td><?php echo isset($value['webpage']) ? $value['webpage'] : ''; ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
