...
<body>
    ...
    <div class="login-clean">
        <form method="post" action="<?php echo base_url('resetpassword/submit'); ?>" style="text-align:center;">
            <p style="color: red">
                <?php
                if (isset($error_msg)) {
                    echo $error_msg;
            ...
            <div class="form-group">
                <input class="form-control" required type="email" name="user_email" placeholder="Registered email"></div>
