...
<body>
    <div style="width:80%;margin:auto;margin-top: 15px;padding:10px;box-shadow: 0px 0px 10px 0px grey;margin-bottom:20px;">
        ...
        <div style="border-bottom:1px solid #e2dfdf;padding: 20px">
            <p style="font-size:16px;font-weight:bold">Basic Information <span><a href="<?php echo base_url('dashboard/basicinfo') ?>" style="font-size:13px;text-align: center;color:#e30613">[Edit]</a></span></p>
        ...
        <div style="border-bottom:1px solid #e2dfdf;padding: 20px">
            <p style="font-size:16px;font-weight:bold">Business Activity <span><a href="<?php echo base_url('dashboard/businessactivity') ?>" style="font-size:13px;text-align: center;color:#e30613">[Edit]</a></span></p>
        ...
        <div style="padding: 20px">
            <p style="font-size:16px;font-weight:bold">Area of Expertise <span><a href="<?php echo base_url('dashboard/areaofexpertise') ?>" style="font-size:13px;text-align: center;color:#e30613">[Edit]</a></span></p>
